...
class ProductPage extends Component {
    ...
    handleAddToCard = () => {
        ...
        if (card !== null) {
            ...
            this.props.updateOrder(new_card.orders)
        }
    ...
    generateInfo = () => {
        return (
            <div>
                ...
                {this.state.product.quantity>0 && <button onClick={this.handleAddToCard} className='btn btn-primary'>Add to cart</button>}
                {this.state.product.quantity<=0  && <h5>Out of stock</h5>}
            </div>
        )
    }
